            ...
            {viewApplicationsPageData.map((applicant,index)=>(
              <tr key={index}>
                ...
                <td className='py-2 px-4 border-b'>
                  <a className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center' href="" target="_blank">Resume <img src={assets.resume_download_icon}></img></a>
                </td>
